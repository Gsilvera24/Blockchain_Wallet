...
def generate_account():
    ...
    #mnemonic = os.getenv("syrup force bridge enhance dignity nature plastic elbow pigeon scrub pull clip")

    # Create Wallet Object
    wallet = Wallet("syrup force bridge enhance dignity nature plastic elbow pigeon scrub pull clip")
